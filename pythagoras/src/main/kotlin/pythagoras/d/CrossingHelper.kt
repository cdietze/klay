 ...
 */
internal class CrossingHelper(private val coords: Array<DoubleArray>, private val sizes: IntArray) {
    ...
    private fun intersectShape(edges: List<Edge>, coords1: DoubleArray, length1: Int,
                               coords2: DoubleArray, length2: Int, initEdge: Edge) {
        val areaOfEdge1: Int
        var areaOfEdge2: Int
        var initBegin: Int
        var initEnd: Int
    ...
    fun containsPoint(point: DoubleArray): Boolean {
    ...
    companion object {
        ...
        // the array sorting
        private fun sort(coords1: DoubleArray, length1: Int,
                         coords2: DoubleArray, length2: Int, array: IntArray) {
            var temp: Int
        ...
        fun compare(x1: Double, y1: Double, x2: Double, y2: Double): Int {
