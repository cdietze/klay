...
class Vector : AbstractVector {
     ...
     * @return a reference to this vector, for chaining.
     */
    fun scaleLocal(v: Double): Vector {
        return scale(v, this)
    }
     ...
     * @return a reference to this vector, for chaining.
     */
    fun addLocal(x: Double, y: Double): Vector {
        return add(x, y, this)
    }
     ...
     * @return a reference to this vector, for chaining.
     */
    fun subtractLocal(x: Double, y: Double): Vector {
     ...
     * @return a reference to this vector, for chaining.
     */
    fun addScaledLocal(other: IVector, v: Double): Vector {
     ...
     * @return a reference to this vector, for chaining.
     */
    fun rotateLocal(angle: Double): Vector {
     ...
     * @return a reference to this vector, for chaining.
     */
    fun lerpLocal(other: IVector, t: Double): Vector {
     ...
     * @return a reference to this vector, for chaining.
     */
    fun set(values: DoubleArray): Vector {
     ...
     * @return a reference to this vector, for chaining.
     */
    operator fun set(x: Double, y: Double): Vector {
        this.x = x
        this.y = y
        return this
    }
     ...
     * @return a reference to this vector, for chaining.
     */
    fun setAngle(angle: Double): Vector {
        val l = length()
