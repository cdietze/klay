...
class Frustum {
     ...
     */
    fun setToPerspective(fovy: Double, aspect: Double, znear: Double, zfar: Double): Frustum {
        val top = znear * Math.tan(fovy / 2f)
        val bottom = -top
     ...
     */
    fun setToFrustum(
            left: Double, right: Double, bottom: Double, top: Double, near: Double, far: Double): Frustum {
     ...
     */
    fun setToProjection(
            left: Double, right: Double, bottom: Double, top: Double, near: Double,
            far: Double, nearFarNormal: IVector3, ortho: Boolean, mirrored: Boolean): Frustum {
    ...
    fun distance(point: Vector3): Double {
        var distance = (-java.lang.Float.MAX_VALUE).toDouble()
