 ...
 */
internal class CurveCrossingHelper(private val coords: Array<DoubleArray>, private val sizes: IntArray,
    ...
    fun findCrossing(): Array<IntersectPoint> {
        val edge1 = DoubleArray(8)
        val edge2 = DoubleArray(8)
        val points = DoubleArray(6)
        val params = DoubleArray(6)
        val mp1 = DoubleArray(2)
        val cp1 = DoubleArray(2)
        val mp2 = DoubleArray(2)
        val cp2 = DoubleArray(2)
        var rule1: Int
        var rule2: Int
        var endIndex1: Int
        var endIndex2: Int
    ...
    private fun currentEdge(areaIndex: Int, index: Int, c: DoubleArray, mp: DoubleArray, cp: DoubleArray): Int {
        var endIndex = 0
    ...
    private fun containsPoint(x: Double, y: Double): Boolean {
