...
@JvmOverloads constructor(contents: Element<*>? = null) : Container.Mutable<Box>() {
    ...
    abstract class Trans protected constructor(duration: Int) : Slot<Clock> {
        ...
        override fun invoke(clock: Clock) {
            ...
            val pct = Math.min(_elapsed / _duration, 1f)
            // TODO: interp!
