...
(
    ...
    @JvmOverloads constructor(
        ...
        init {
            if (menu == null) throw IllegalArgumentException()
    ...
    fun popup(pop: Pop) {
        ...
        activation.deactivated = pop.menu.deactivated().connect(object : Slot<Menu>() {
            fun onEmit(event: Menu) {
        ...
        activation.triggerRemoved = pop.trigger.hierarchyChanged().connect(object : Slot<Boolean>() {
    ...
    companion object {
        ...
        protected fun avoidPoint(outer: IRectangle, inner: Rectangle, fingerprint: IRectangle): Boolean {
            ...
            var bestDist = java.lang.Float.MAX_VALUE
            var edge: Float
            ...
            return bestDist < java.lang.Float.MAX_VALUE
        }
