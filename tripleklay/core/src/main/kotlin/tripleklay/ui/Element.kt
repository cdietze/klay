...
abstract class Element<T : Element<T>> protected constructor() {
     ...
     */
    open fun wasAdded() {
        if (_hierarchyChanged != null) _hierarchyChanged!!.emit(java.lang.Boolean.TRUE)
        invalidate()
    ...
    open fun wasRemoved() {
        _bginst.clear()
        if (_hierarchyChanged != null) _hierarchyChanged!!.emit(java.lang.Boolean.FALSE)
