...
class Deflater : Conflater() {
    ...
    fun addByte(value: Int): Deflater {
        check(value, java.lang.Byte.MIN_VALUE.toInt(), java.lang.Byte.MAX_VALUE.toInt(), "Byte")
        _buf.append(Conflater.toHexString(value, 2))
        return this
    }

    fun addShort(value: Int): Deflater {
        check(value, java.lang.Short.MIN_VALUE.toInt(), java.lang.Short.MAX_VALUE.toInt(), "Short")
    ...
    fun addVarLong(value: Long): Deflater {
        var value = value
        assert(value > java.lang.Long.MIN_VALUE) { "Can't use varlong for Long.MIN_VALUE" }
        if (value < 0) {
            _buf.append(Conflater.NEG_MARKER)
            value *= -1
        }
    ...
    protected val _buf = StringBuilder()
}
