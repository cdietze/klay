...
(source: TileSource, protected val _width: Float, protected val _height: Float, protected val _count: Int) : Frames {
     ...
     * @param height the width of each frame.
     */
    @JvmOverloads constructor(source: Tile, width: Float, height: Float = source.height) : this(source, width, height, (source.height / height) as Int * (source.height / width) as Int) {}
