...
object SimpleStyles {
    ...
    fun newSheetBuilder(gfx: Graphics): Stylesheet.Builder {
        ...
        return Stylesheet.builder().add(Button::class,
                Style.BACKGROUND.`is`(butBg)).add(Button::class, Style.Mode.SELECTED,
                Style.BACKGROUND.`is`(butSelBg)).add(ToggleButton::class,
                Style.BACKGROUND.`is`(butBg)).add(ToggleButton::class, Style.Mode.SELECTED,
                Style.BACKGROUND.`is`(butSelBg)).add(CheckBox::class,
                Style.BACKGROUND.`is`(Background.roundRect(gfx, bgColor, 5f, ulColor, 2f).inset(3f, 2f, 0f, 3f))).add(CheckBox::class, Style.Mode.SELECTED,
                Style.BACKGROUND.`is`(Background.roundRect(gfx, bgColor, 5f, brColor, 2f).inset(3f, 2f, 0f, 3f))).add(Field::class,
                ...
                .add(MenuItem::class,
                        ...
                        Style.HALIGN.left).add(MenuItem::class, Style.Mode.SELECTED,
                Style.BACKGROUND.`is`(Background.solid(0xFF000000.toInt())),
                Style.COLOR.`is`(0xFFFFFFFF.toInt())).add(Tabs::class,
