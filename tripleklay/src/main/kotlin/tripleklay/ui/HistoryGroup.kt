...
protected constructor() : Composite<HistoryGroup<T, W>>() {
    ...
    fun scrollToBottom() {
        _scroller.queueScroll(0f, Float.MAX_VALUE)
    }
    ...
    fun pruneOld(adjustment: Int) {
        if (adjustment != 0) {
            ...
            _entries.subList(0, minOf(adjustment, _entries.size)).clear()
    ...
    protected inner class EntriesGroup : Group(EntriesLayout()), Scroller.Clippable {
        ...
        override fun setPosition(x: Float, y: Float) {
            ...
            if (_viewHeight > bounds.height) {
                ...
                layer.setTranslation(x, floor(y.toDouble()).toFloat())
        ...
        fun removeOldEntries(minIndex: Int) {
            removeEntriesNotInRange(minIndex, Int.MAX_VALUE)
        }
