...
class TypedStorage(protected val _log: Log, protected val _storage: Storage) {
    ...
    fun get(key: String, defval: Int): Int {
        ...
        try {
            ...
            return if (value == null) defval else value.toInt()
        } catch (e: Exception) {
    ...
    fun get(key: String, defval: Long): Long {
        ...
        try {
            value = _storage.getItem(key)
            return if (value == null) defval else value.toLong()
        } catch (e: Exception) {
    ...
    fun get(key: String, defval: Double): Double {
        ...
        try {
            value = _storage.getItem(key)
            return if (value == null) defval else value.toDouble()
        } catch (e: Exception) {
...
//    fun <E> setFor(key: String, toFunc: Function<String, E>,
