...
(protected val _game: Game, protected val _rootLayer: GroupLayer) {
     ...
     */
    fun push(screen: Screen, trans: Transition = defaultPushTransition()) {
        if (_screens.isEmpty()) {
            addAndShow(screen)
        } else {
            val otop = top()!!
     ...
     */
    fun push(screens: Iterable<Screen>, trans: Transition = defaultPushTransition()) {
     ...
     * all screens.
     */
    fun popTo(newTopScreen: Screen, trans: Transition = defaultPopTransition()) {
     ...
     * @throws IllegalArgumentException if the supplied screen is already in the stack.
     */
    fun replace(screen: Screen, trans: Transition = defaultPushTransition()) {
        if (_screens.isEmpty()) {
            addAndShow(screen)
        } else {
     ...
     * * in the stack.
     */
    fun remove(screen: Screen, trans: Transition = defaultPopTransition()): Boolean {
     ...
     */
    fun remove(pred: Predicate, trans: Transition = defaultPopTransition()) {
