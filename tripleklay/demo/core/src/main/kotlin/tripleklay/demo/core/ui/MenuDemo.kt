...
// TODO(cdi) re-add when MenuHost is ported
...
//        val direction = Button("Select a direction \u25BC").addStyles(MenuHost.TRIGGER_POINT.`is`(MenuHost.relative(popRight))).onClick(object : Slot<Button>() {
//            fun onEmit(self: Button) {
...
//            }
//        })
//        val tree = Button("Select a tree \u25BC").addStyles(MenuHost.TRIGGER_POINT.`is`(MenuHost.relative(popUnder))).onClick(object : Slot<Button>() {
//            fun onEmit(self: Button) {
//                val pop = MenuHost.Pop(self,
...
//                MenuHost.POPUP_ORIGIN.`is`(BoxPoint.BR)).onClick(object : Slot<Button>() {
//            fun onEmit(self: Button) {
//                val pop = MenuHost.Pop(self,
...
//                g.setStylesheet(Stylesheet.builder().add(MenuItem::class.java, Styles.none().add(Style.BACKGROUND.`is`(Background.blank().inset(5, 1))).addSelected(Style.BACKGROUND.`is`(Background.solid(Colors.BLACK).inset(5, 1)))).create())
//                for (col in 0..9) {
//                    for (row in 0..9) {
...
//            }
//
//            protected override fun wasRemoved() {
//                super.wasRemoved()
...
//                        Style.BACKGROUND.`is`(Background.beveled(0xFF8F8F8F.toInt(), 0xFF4F4F4F.toInt(), 0xFFCFCFCF.toInt()).inset(4))))
...
//                menu.add(Label("Select a byte").addStyles(Style.COLOR.`is`(0xFFFFFFFF.toInt()),
//                        Style.BACKGROUND.`is`(Background.beveled(0xFF8F8F8F.toInt(), 0xFF4F4F4F.toInt(), 0xFFCFCFCF.toInt()).inset(4))).setConstraint(TableLayout.Colspan(2)))
//                val prev = Button("<< Previous").onClick(menu.incrementPage(-1))
//                val next = Button("Next >>").onClick(menu.incrementPage(1))
//                menu.add(prev, next)
//                val updateEnabling = object : UnitSlot() {
//                    fun onEmit() {
...
//                slider.value.connect(object : Slot<Float>() {
//                    fun onEmit(`val`: Float?) {
//                        menu.setPage(FloatMath.round(`val`))
//                    }
//                })
//                menu.page().connect(object : Slot<Int>() {
//                    fun onEmit(page: Int?) {
//                        slider.value.update(page!!.toFloat())
//                    }
//                })
//                menu.numPages().connect(object : Slot<Int>() {
//                    fun onEmit(numPages: Int?) {
...
//                        Style.BACKGROUND.`is`(Background.solid(Colors.BLUE).inset(2))).add(Style.BACKGROUND.`is`(Background.blank().inset(2)))
//                val colorTable = Group(TableLayout(4))
//                for (ii in 0..255) {
//                    val colorImg = graphics().createCanvas(16, 16)
...
//        return object : Slot<MenuItem>() {
//            fun onEmit(item: MenuItem) {
...
//        for (item in menu) {
//            if (item is MenuItem) {
//                (item as MenuItem).icon.update(tile(tile++))
//            }
//        }
//        return menu
//    }
...
//        for (item in menu) {
//            if (item is MenuItem) {
//                (item as MenuItem).showText(showText)
//            }
//        }
//        return menu
//    }
