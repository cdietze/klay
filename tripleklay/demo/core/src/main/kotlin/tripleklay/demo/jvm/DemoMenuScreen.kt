...
import tripleklay.demo.jvm.anim.AnimDemo
import tripleklay.demo.jvm.anim.FlickerDemo
...
class DemoMenuScreen(protected val _stack: ScreenStack) : ScreenStack.UIScreen(TripleDemo.game!!.plat) {
    ...
    init {
        ...
        _screens = arrayOf<DemoScreen?>(
                // tripleplay.ui
                // TODO(cdi) MiscDemo(), LabelDemo(), MenuDemo(), SliderDemo(), SelectorDemo(), BackgroundDemo(), ScrollerDemo(), TabsDemo(), HistoryGroupDemo(), LayoutDemo(), FlowLayoutDemo(), BorderLayoutDemo(), TableLayoutDemo(), AbsoluteLayoutDemo(), null,
                // tripleplay.anim
