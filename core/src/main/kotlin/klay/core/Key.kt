...
enum class Key {
    ...
    // Punctuation
    AMPERSAND,
    ASTERISK, AT, BACKQUOTE, BACKSLASH, BANG, CIRCUMFLEX, COLON, COMMA, DOLLAR,
    ...
    // Modifiers
    ALT,
    CONTROL, CAPS_LOCK, SHIFT, META,

    // Navigation
    DOWN,
    END, HOME, LEFT, PAGE_UP, PAGE_DOWN, RIGHT, UP,

    // Other printing/editing
    BACKSPACE,
    DELETE, ENTER, INSERT, TAB,

    // Other non-printing
    ESCAPE,
    PAUSE, PRINT_SCREEN, SCROLL_LOCK, WINDOWS,

    // Flash/Android/mobile keys
    MEDIA_CLOSE,
    MEDIA_EJECT, MEDIA_FAST_FORWARD, MEDIA_NEXT, MEDIA_PAUSE, MEDIA_PLAY,
    MEDIA_PLAY_PAUSE, MEDIA_PREVIOUS, MEDIA_RECORD, MEDIA_REWIND, MEDIA_STOP,
    BLUE, GREEN, RED, YELLOW,

    // Android/mobile keys
    APP_SWITCH,
    AVR_INPUT, AVR_POWER, BACK, BOOKMARK, BREAK, BUTTON_1, BUTTON_2, BUTTON_3,
